...
<head>
    ...
    <meta name="google-site-verification" content="qN6tpF1nYU6jLBG1kgH3IGlCbIaXji5oFkn5Mg6h8Vw" />
        ...
        <div class="footer1-contact-info">
          ...
          <div class="single-footer">
            ...
            <div class="social-links-mobile-menu">
              <ul>
                <li><a href="https://www.facebook.com/itnext77/"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="https://www.instagram.com/itnextbd11/"><i class="fa-brands fa-instagram"></i></a></li>
                <li><a href="https://www.linkedin.com/in/it-next-bd-it-company-416b1834a/"><i class="fa-brands fa-linkedin-in"></i></a></li>
                <li><a href="https://x.com/ITNextBD236789"><i class="fa-brands fa-x"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <div class="footer-logo-area">
          ...
          <ul>
            <li><a href="https://www.facebook.com/itnext77/"><img src="{{asset('frontend')}}/img/icons/facebook.svg" alt=""></a></li>
            <li><a href="https://www.instagram.com/itnextbd11/"><img src="{{asset('frontend')}}/img/icons/instagram.svg" alt=""></a></li>
            <li><a href="https://www.linkedin.com/in/it-next-bd-it-company-416b1834a/"><img src="{{asset('frontend')}}/img/icons/linkedin.svg" alt=""></a></li>
            <li><a href="https://x.com/ITNextBD236789"><img src="{{asset('frontend')}}/img/icons/youtube.svg" alt=""></a></li>
          </ul>
        </div>
      </div>
