            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    ...
                    <ul class="social-links">
                        <li><a href="https://www.linkedin.com/in/it-next-bd-it-company-416b1834a/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                        <li><a href="https://www.facebook.com/itnext77/" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="https://www.instagram.com/itnextbd11/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                        <li><a href="https://x.com/ITNextBD236789" target="_blank"><i class="fab fa-youtube"></i></a></li>
                            ...
                            <div class="footer-widget contact-widget">
                                ...
                                <div class="widget-content">
                                    ...
                                    <ul class="social-icons">
                                        <li><a href="https://www.linkedin.com/in/it-next-bd-it-company-416b1834a/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
                                        <li><a href="https://www.facebook.com/itnext77/" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                                        <li><a href="https://www.instagram.com/itnextbd11/" target="_blank"><i class="fa-brands fa-tiktok"></i></a></li>
                                        <li><a href="https://x.com/ITNextBD236789" target="_blank"><i class="fa-brands fa-x"></i></a></li>
                    ...
                    <div class="inner-container">
                        <div class="copyright-text">
                            @if ($setting->first()->footer != null)
                                {{ $setting->first()->footer }} | Design and Development By <a class="text-danger" href="https://www.itnextbd.com/">Aim World</a>
                            @endif
                        </div>
                    </div>
                </div>
