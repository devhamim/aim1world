...
@section('title', $metaSettings->title ?? 'Aim1world - About')
@section('meta_description', $metaSettings->meta_description ?? 'About' )
@section('meta_title', $metaSettings->meta_title ?? 'Aim1world - About' )
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-5">
        <div class="about-content-area heading2">
          ...
          <p>Welcome to Aim World your trusted partner for comprehensive Graphics Design, SEO, digital marketing Website and Software. With our proven expertise and innovative strategies the digital landscape.</p>
        </div>
      </div>
      <div class="col-lg-3">
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="history-header-area text-center heading2">
                    ...
                    <img src="{{ asset('frontend') }}/img/elements/star7.png" alt="" class="star3 keyframe5">
                    <h5>Our History</h5>
                    <h2>Our Journey: Charting the <br class="d-lg-block d-none"> Evolution of Aim World</h2>
                </div>
            </div>
        </div>
        <div class="row align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                ...
                                <p>Building on our success, Aim World expanded our service offerings to better meet the evolving needs. </p>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="history-box-content">
                                ...
                                <p>Aim World formed strategic partnerships and collaborations with industry leaders and technology providers. </p>
