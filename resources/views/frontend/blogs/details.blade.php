...
@section('title', 'Aim World - '. $blogs->title ?? 'Aim World - Blog Details')
@section('meta_description',  $blogs->meta_description ?? $blogs->title)
@section('meta_title', 'Aim World - '. $blogs->meta_title ?? 'Aim World - '.$blogs->title)
                ...
                <div class="blog-details__left">
                    ...
                    <div class="blog-details__bottom">
                        ...
                        <div class="blog-details__social-list">
                            <a href="https://www.instagram.com/itnextbd11/">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="https://www.facebook.com/itnext77/">
                                <i class="fab fa-facebook"></i>
                            </a> <a href="https://www.linkedin.com/in/it-next-bd-it-company-416b1834a/">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="https://x.com/ITNextBD236789">
                                <i class="fab fa-x"></i>
                            </a>
                        </div>
                    </div>
