...
@section('title', 'Aim World - '.  $products->first()->product_name ?? 'Aim World - Product Details')
@section('meta_description',   $products->first()->meta_description ??  $products->first()->product_name)
@section('meta_title', 'Aim World - '.  $products->first()->meta_title ?? 'Aim World - '.  $products->first()->product_name)
