...
@section('title', $metaSettings->title ?? 'Aim World - Home')
@section('meta_description', $metaSettings->meta_description ?? 'Home' )
@section('meta_title', $metaSettings->meta_title ?? 'Aim World - Home' )
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="header-main-content heading1">
            ...
            <p data-aos="fade-left" data-aos-duration="1000">Welcome to Aim World where we specialize in revolutionizing your online <br class="d-lg-block d-none"> presence through expert programmer and software engineer. </p>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-5">
          <div class="about-content-area heading2">
            ...
            <p data-aos="fade-left" data-aos-duration="1000">Welcome to Aim World your trusted partner for comprehensive Graphics Design, SEO, digital marketing Website and Software. With our proven expertise and innovative strategies the digital landscape.</p>
            <div class="btn-area" data-aos="fade-left" data-aos-duration="1200">
        ...
        <div class="col-lg-7">
          <div class="images-content-area" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="arrow-area">
              <a href="{{ route('our.services') }}"><i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-5">
            ...
            <div class="row">
              <div class="col-lg-12 col-md-6">
                <div class="service2-auhtor-boxarea" data-aos="zoom-out" data-aos-duration="1000">
                  ...
                  <div class="content-area">
                    <h5>Our Mission</h5>
                    <a href="{{ route('about') }}">We strive to be more than just a service provider; we aim to be trusted Aim World </a>
              ...
              <div class="col-lg-12 col-md-6">
                <div class="service2-auhtor2-boxarea" data-aos="zoom-out" data-aos-duration="1200">
                  ...
                  <div class="content-area">
                    <h5>Our Vision</h5>
                    <a href="{{ route('about') }}">We aspire to create a world where every business owner feels empowered</a>
      ...
      <div class="row">
        <div class="col-lg-12 m-auto">
          <div class="testimonial-header heading2 text-center">
            ...
            <p data-aos="fade-up" data-aos-duration="1000">Don't just take our word for it. Hear what our satisfied clients <br class="d-md-block d-none"> have to say about their experience partnering with Aim World</p>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="testimonials-slider-area owl-carousel">
            <div class="testimonial-boxarea">
              <div class="row">
                <div class="col-lg-5">
                  <div class="pera">
                    <p>"The team delivered exceptional results, from a stunning website to effective SEO and engaging content. Their work boosted our traffic, brand visibility, and overall business growth. Highly recommended!.</p>
                ...
                <div class="col-lg-7">
                  <div class="images">
                    <img src="{{asset('frontend')}}/img/all-images/testimonial-img1.png" alt="">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="testimonial-boxarea">
              <div class="row">
                <div class="col-lg-5">
                  <div class="pera">
                    <p>"Working with Aim World has been a game-changer for our business. Their expertise in SEO and digital marketing has helped us achieve remarkable results and significantly increase our online visibility.</p>
                    <div class="space100"></div>
                    <div class="space30"></div>
                    <div class="list-area">
                      <div class="list">
                ...
                <div class="col-lg-7">
                  <div class="images">
                    <img src="{{asset('frontend')}}/img/all-images/testimonial-img2.png" alt="">
                  </div>
                </div>
              </div>
            </div>
